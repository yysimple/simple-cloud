...
import com.simple.gen.config.GenConfig;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        if (arraysContains(CodeGenConstants.COLUMNTYPE_STR, dataType)) {
        ...
        // 编辑字段
        if (!arraysContains(CodeGenConstants.COLUMNNAME_NOT_EDIT, columnName) && !column.isPk()) {
            column.setIsEdit(CodeGenConstants.REQUIRE);
        }
        // 列表字段
        if (!arraysContains(CodeGenConstants.COLUMNNAME_NOT_LIST, columnName) && !column.isPk()) {
            column.setIsList(CodeGenConstants.REQUIRE);
        }
        // 查询字段
        if (!arraysContains(CodeGenConstants.COLUMNNAME_NOT_QUERY, columnName) && !column.isPk()) {
