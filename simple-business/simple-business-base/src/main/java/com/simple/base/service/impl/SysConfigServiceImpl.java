...
import com.simple.common.redis.service.RedisService;
import com.simple.base.domain.SysConfig;
import com.simple.base.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    public int deleteConfigByIds(Long[] configIds) {
        ...
        if (count > 0) {
            Collection<String> keys = redisService.keys(CommonConstants.SYS_CONFIG_KEY + "*");
