...
public class SysUserController extends BaseController {
    ...
    public Result<UserInfo> info(@PathVariable("username") String username) {
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user) {
        ...
        } else if (SystemConstants.NOT_UNIQUE.equals(userService.checkPhoneUnique(user))) {
            return AjaxResult.error("新增用户'" + user.getUserName() + "'失败，手机号码已存在");
        } else if (SystemConstants.NOT_UNIQUE.equals(userService.checkEmailUnique(user))) {
    ...
    public AjaxResult edit(@Validated @RequestBody SysUser user) {
        ...
        if (SystemConstants.NOT_UNIQUE.equals(userService.checkPhoneUnique(user))) {
